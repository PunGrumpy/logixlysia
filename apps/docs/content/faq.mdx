...
```bash
bun add createLogPlugin@next
```

Or with npm:

```bash
npm install createLogPlugin@next
```
...
- Node.js 18+ or Bun
- Elysia 2.0.0-beta.2 or newer (`createLogPlugin@next`), or Elysia 1.4 (`createLogPlugin@latest`)
- TypeScript 5.7+
...
2. Replace your logging setup with `createLogPlugin()`
...
- [Documentation](/)
- [GitHub Issues](https://github.com/PunGrumpy/createLogPlugin/issues)

### How do I report a bug?

Open an issue on [GitHub](https://github.com/PunGrumpy/createLogPlugin/issues) with:
