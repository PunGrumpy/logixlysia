...
```bash
bun add createElogs@next
```

Or with npm:

```bash
npm install createElogs@next
```
...
- Node.js 18+ or Bun
- Elysia 2.0.0-beta.2 or newer (`createElogs@next`), or Elysia 1.4 (`createElogs@latest`)
- TypeScript 5.7+
...
- [Documentation](/)
- [GitHub Issues](https://github.com/PunGrumpy/createElogs/issues)

### How do I report a bug?

Open an issue on [GitHub](https://github.com/PunGrumpy/createElogs/issues) with:
