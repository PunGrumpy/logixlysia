...
Logixlysia is a powerful logging plugin for [Elysia.js](https://elysiajs.com/) that provides structured logging with a fast built-in console logger, plus an optional [Pino integration](/integrations/pino) when you need Pino's ecosystem. Built for production environments, it offers flexible configuration, file logging, and seamless integration with your Elysia applications.
...
Logixlysia combines the simplicity of Elysia's plugin system with a fast built-in console logger, plus an optional [Pino integration](/integrations/pino) for teams that want Pino's ecosystem. It provides a clean API for logging requests, responses, and custom events while maintaining minimal overhead.
...
- [Explore features](/features/startup)
