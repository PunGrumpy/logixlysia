...
Looking for Axiom, Better Stack, ClickHouse, Datadog, HyperDX, Loki, OTLP, PostHog, or Sentry? Built-in [adapters](/adapters/overview) cover those — with batching, retries, and credential handling included. Custom transports are for everything else.
