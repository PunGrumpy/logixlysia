...
- [`LogLevel`](https://elogs.vercel.app/docs/api/types#log-level) — 4 个字面量
- [`LogFilter`](https://elogs.vercel.app/docs/api/types#log-filter) — `{ level?: LogLevel[] }`
- [`ElogsConfig.logFilter`](https://elogs.vercel.app/docs/api/configuration#elogs-config) — 配置字段
- [`CreateElogsOptions.logLevel`](https://elogs.vercel.app/docs/api/configuration#create-elogs-options) — 根级别名
