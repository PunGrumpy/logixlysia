...
- [`translateDrizzleError`](/docs/api/functions#translate-drizzle-error) — 翻译一个 error
- [`isDrizzleError`](/docs/api/functions#is-drizzle-error) — Drizzle 错误类型守卫
- [`DrizzleLikeError`](/docs/api/interfaces#drizzle-like-error) — Drizzle 错误最小形状
- [`AutoTranslateConfig`](/docs/api/interfaces#auto-translate-config) — `autoTranslate` 配置形状
- [`ErrorTranslator`](/docs/api/types#error-translator) — 自定义翻译器形状
