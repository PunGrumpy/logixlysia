...
description: Customize startup messages in Elogs
---

Control how your application announces its startup with Elogs's flexible startup message system.
...
```
🦊 Elogs is running on http://localhost:3000
```
