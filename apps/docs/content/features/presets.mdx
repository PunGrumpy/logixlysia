...
- [`registerPreset`](/docs/api/exports#registerpreset) — 注册自定义 preset
- [`getPresetDefaults`](/docs/api/exports#getpresetdefaults) — 查表
- [`listPresets`](/docs/api/exports#listpresets) — 列出当前已注册名
- [`resolveOptions`](/docs/api/exports#resolveoptions) — 手动跑 merge
- [`__resetPresetRegistry`](/docs/api/exports#resetpresetregistry) — 测试重置
- [`LogPreset`](/docs/api/types#logpreset) / [`PresetConfig`](/docs/api/types#presetconfig) — 类型
