...
On Elysia 1.4, install from the `latest` tag (`bun add logixlysia`), which stays on Logixlysia 6.x. [Use Logixlysia with Elysia 2](https://logixlysia.vercel.app/docs/elysia-2) lists which Logixlysia version goes with which Elysia release.
